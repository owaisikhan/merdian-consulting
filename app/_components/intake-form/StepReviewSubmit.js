    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between pt-2">
        <button
          ...
          className="cursor-pointer rounded-md border border-neutral-300 px-6 py-2 text-sm font-medium text-neutral-700 transition hover:bg-neutral-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Back
        </button>
        <button
